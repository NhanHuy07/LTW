...
public class Pages {
    public static final String ADMIN_CARS = "admin-products";
    public static final String ADMIN_EDIT_CAR = "admin-edit-cars";
    public static final String ADMIN_ADD_CAR = "admin-add-cars";
    ...
    public static final String CAR = "product";
